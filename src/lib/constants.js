export const COMPANY = {
  ...
  email: 'maximsiskowski@icloud.com',
...
export const SERVICES = [
  ...
  },
  {
    ...
    bullets: ['Ausgebildetes Brandschutzpersonal (§ 34a GewO)','Regelmäßige Begehungen & Protokollierung','Koordination mit Feuerwehr & Rettungsdiensten','Betrieblicher Brandschutzbeauftragter auf Anfrage'],
    highlight: false,
  },
];
...
export const ADVANTAGES = [
  ...
  { icon: 'BadgeCheck',        title: 'Zertifiziertes Personal',    description: 'Alle unsere Mitarbeiter sind nach § 34a GewO geprüft, regelmäßig geschult und tragen einheitliche, erkennbare Uniform & Ausrüstung.' },
...
export const FAQS = [
  ...
  { question: 'Sind Ihre Mitarbeiter nach § 34a GewO geprüft?',            answer: 'Ja, absolut. Alle unsere Sicherheitsmitarbeiter sind geprüft nach § 34a Gewerbeordnung und absolvieren regelmäßige interne Schulungen zu Erste Hilfe, Deeskalation und rechtlichen Grundlagen.' },
